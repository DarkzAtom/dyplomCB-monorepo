from scrapers.enisaeuropa import all_links_collector
from scrapers.enisaeuropa import async_individual_link_processor
import csv
import asyncio
...
def main():
    ...
    csv_file = "scrapers/enisaeuropa/output.csv"
