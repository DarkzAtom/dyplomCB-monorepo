from scrapers.cybersecuritydive import all_links_collector
from scrapers.cybersecuritydive import async_individual_link_processor
import csv
import asyncio
...
def main():
    ...
    final_list = asyncio.run(async_individual_link_processor.process_links_async(collected_links_list))
    ...
    csv_file = "scrapers/cybersecuritydive/output.csv"
