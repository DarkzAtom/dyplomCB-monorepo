...
class AsyncLinkProcessor:
    ...
    async def process_link(self, url: str, session: aiohttp.ClientSession) -> Dict[str, Any]:
        ...
        try:
            ...
            creation_date = soup.select_one('span.published-info').text.strip()
            article_title = soup.select_one('div.article-title-wrapper > h1.display-heading-04').text.strip()


            article_text = soup.select_one('div.large.medium.article-body')
            if article_text:
                unwanted_container_to_destroy = article_text.select_one('div.text-to-speech')
            ...
            article_dict = {
                    ...
                    'authorLink': 'https://www.cybersecuritydive.com/',
                    'articleLink': url,
...
if __name__ == "__main__":
    urls_to_process = [
        ...
        "https://www.cybersecuritydive.com/news/ransomware-attacks-it-food-sectors/812210/"
    ]
